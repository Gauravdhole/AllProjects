package ProjectMaven.Maven.generator;
...
public class MyBatisPlusGenerate {
     ...
     * 作者
     */
    private static final String AUTHOR = "THINKCLOUD.GEN";
     ...
     * JDBC 连接地址
     */
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/dbname?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
     ...
     * 包配置 - 父级目录
     */
    private static final String PACKAGE_PARENT = "com.chinagoods";
     ...
     * 要生成的表，用 `,` 分割
     */
    private static final String TABLES = "tb_table_name";
    ...
    private static PackageConfig packageConfig() {
        ...
        // 设置模块的名字，比如 core，生成效果为 com.xxx.core
    ...
    private static StrategyConfig strategyConfig() {
        ...
        // 表前缀
        config.setTablePrefix(packageConfig().getModuleName() + "fc_");
        ...
        // CommonBase
        config.setSuperEntityColumns("id", "create_time", "update_time", "create_by", "update_by", "is_deleted");
        config.setSuperEntityClass("ProjectMaven.Maven.domain.Domain");
        config.setSuperServiceClass("com.chinagoods.framework.thinkcloud.base.commons.api.BaseService");
        config.setSuperServiceImplClass(
                "com.chinagoods.framework.thinkcloud.commons.business.api.impl.BaseServiceImpl");
        config.setSuperControllerClass("com.chinagoods.framework.thinkcloud.commons.controller.BaseController");
    ...
    public static void main(String[] args) {
        ...
        generator.setGlobalConfig(globalConfig().setServiceName("%sService"));
